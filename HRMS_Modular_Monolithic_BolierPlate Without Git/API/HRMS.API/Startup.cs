...
namespace HRMS.API
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddInjectionApplication(configuration, [typeof(CreateTodoHandler).Assembly, typeof(EmployeeFeature.Application.DTO.CreateEmployeeHandler).Assembly, typeof(AttendanceFeature.Application.DTO.CreateAttendanceHandler).Assembly, typeof(LeaveFeature.Application.DTO.CreateLeaveHandler).Assembly, typeof(PayrollFeature.Application.DTO.CreatePayrollHandler).Assembly]);
