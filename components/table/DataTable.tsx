		...
		<div className={`relative ${className ?? ""}`}>
			...
			<div className="mb-3 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
				...
				<div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
					...
					<button
						type="button"
						className="inline-flex justify-center items-center gap-2 rounded border border-border bg-background px-3 py-2"
						onClick={() => {
...
function FilterDrawer(props: {
	...
	return (
		<Fragment>
			...
			<div
				className={`fixed right-0 top-0 z-50 h-full w-full sm:w-[340px] transform border-l border-border bg-background shadow-xl transition-transform ${
